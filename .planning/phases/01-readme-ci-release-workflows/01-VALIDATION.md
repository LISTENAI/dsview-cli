...
| 01-01-03 | 01 | 1 | D-06, D-14, D-17 | package helper validation | Host-target dry run of `tools/package-bundle.py` creates a versioned archive root with `runtime/`, `resources/`, and the correct DSLogic Plus payload | ✅ | ✅ complete |
| 01-01-04 | 01 | 1 | D-06, D-14, D-17 | bundle validator smoke coverage | `tools/validate-bundle.py` verifies archive layout, target runtime filename, declared bundled companion libraries when applicable, `dsview-cli --help`, `dsview-cli devices list --help`, and the repo-owned bundle-discovery validation path | ✅ | ✅ complete |
